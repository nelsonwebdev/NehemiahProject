      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        >
          <div className="w-8 h-8 rounded-sm bg-white/20 flex items-center justify-center">
            <span style={{ fontFamily: "'Playfair Display', serif", color: "#ffffff", fontWeight: 700, fontSize: "13px" }}>
              NU
            </span>
          </div>
          <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "16px", fontWeight: 600, letterSpacing: "0.02em" }}>
            Nelson University
          </span>
        </button>
        ...
        <nav className="hidden md:flex items-center gap-1">
          {navLinks.map(({ label, page }) => (
            <button
              ...
              style={{ fontFamily: "'Inter', sans-serif", letterSpacing: "0.05em", textTransform: "uppercase", fontSize: "12px" }}
            >
              {label}
              {currentPage === page && (
