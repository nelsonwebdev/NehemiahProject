  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <span
        ...
        style={{ fontFamily: "'Inter', sans-serif", fontSize: "10px", letterSpacing: "0.15em" }}
      >
        {label}
      </span>
    </div>
    ...
    >
      ...
      <div className="relative flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <div className="flex items-center gap-3 mb-16">
          <div
            className="w-9 h-9 flex items-center justify-center bg-white/20"
          >
            <span style={{ fontFamily: "'Playfair Display', serif", color: "#ffffff", fontWeight: 700, fontSize: "14px" }}>
              NU
            </span>
          </div>
          <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "17px", fontWeight: 600, color: "white", letterSpacing: "0.02em" }}>
            Nelson University
          </span>
        </div>
        ...
        <p
          ...
          style={{ fontFamily: "'Inter', sans-serif", fontSize: "11px", letterSpacing: "0.2em" }}
        >
        ...
        >
          Named for the biblical builder who rallied a community around an audacious goal,
          the Nehemiah Project will transform Nelson's capacity to fulfill its mission —
          equipping students, empowering faculty, and strengthening the institution
          for the next century of Kingdom work.
        </p>
        ...
        <div className="mb-4">
          <p
            ...
            style={{ fontFamily: "'Inter', sans-serif", fontSize: "10px", letterSpacing: "0.18em" }}
          >
            {done ? "The campaign has launched" : "Public launch begins in"}
          </p>
          <div className="flex items-start gap-4 sm:gap-6 justify-center">
            <CountdownUnit value={days} label="Days" />
            <span className="text-white/30 mt-3" style={{ fontSize: "clamp(1.5rem, 4vw, 2.5rem)", fontFamily: "'Playfair Display', serif" }}>:</span>
        ...
        {/* Divider */}
        <div className="w-24 h-px my-14" style={{ backgroundColor: "#a1a8ae", opacity: 0.4 }} />

        {/* Early giving section */}
        <div className="max-w-2xl w-full">
          <p
            className="uppercase tracking-widest mb-4"
            style={{ fontFamily: "'Inter', sans-serif", fontSize: "10px", letterSpacing: "0.18em", color: "#c5c0e0" }}
          >
            Give Early
          </p>
          <h2
          ...
          >
            Gifts made before the public launch count toward our momentum — and early donors
            play a vital role in demonstrating the community's commitment.
            Contact the Advancement Office to make a gift today or to explore pledge and planned giving options.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-left">
            {[
              {
                label: "Visit Us",
                lines: ["University Advancement", "Farmer Administration Bldg", "1200 Sycamore St.", "Waxahachie, TX 75165"],
                href: null,
              },
              {
                label: "Call Us",
              ...
              >
                <p
                  ...
                  style={{ fontFamily: "'Inter', sans-serif", fontSize: "9px", letterSpacing: "0.18em", color: "#c5c0e0" }}
                >
                  {label}
                </p>
                {lines.map((line) =>
