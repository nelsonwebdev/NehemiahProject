    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2">
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(1.4rem, 2.5vw, 1.9rem)" }} className="mb-5">
            A Foundation Built on Bold Vision
          </h2>
          <div className="space-y-4 text-muted-foreground leading-relaxed text-sm">
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum malesuada turpis nec arcu tempor, non convallis tortor viverra. Sed sollicitudin est erat, pharetra iaculis orci vestibulum sit amet. Phasellus et consectetur orci. Maecenas quis dui placerat, faucibus lectus quis, volutpat leo. Nulla efficitur nisi nec mauris porttitor mattis. Pellentesque ut urna quis ipsum maximus sollicitudin. Duis aliquet metus elit. Quisque vitae libero id lacus venenatis tempor et non ipsum. 
            </p>
            <p>
              Maecenas volutpat pellentesque velit ac interdum. Nullam consequat bibendum augue, nec molestie nisl vulputate sed. Sed molestie et tellus eu lobortis. Fusce non ante sit amet lacus semper ullamcorper porta ut diam. Nunc sed congue massa. Nullam fermentum mauris ut tellus auctor semper. Etiam in turpis et ligula pellentesque tincidunt. Vivamus pellentesque mattis ante nec dictum.
            </p>
            <p>
              Suspendisse fermentum accumsan purus quis varius. Suspendisse sapien metus, cursus id tristique nec, placerat vitae lacus. Integer at augue dui. Vestibulum tortor sapien, ultrices tincidunt lacinia id, suscipit at leo. Quisque a lacinia turpis, sed tempus tortor. Sed risus ex, congue eget posuere euismod, tincidunt sed quam. Aenean consequat molestie lorem non ultrices. Sed pharetra lorem quis turpis lacinia faucibus.
            </p>
          </div>
        </div>
        <div className="space-y-4">
          {[
            ...
            <div key={label} className="border-b border-border pb-4 flex justify-between items-baseline">
              <span className="text-muted-foreground text-sm">{label}</span>
              <span className="text-primary" style={{ fontFamily: "'Playfair Display', serif", fontSize: "22px", fontWeight: 600 }}>
                {value}
              </span>
            </div>
          ))}
      ...
      {/* Timeline */}
      <section className="border-y border-border py-16" style={{ backgroundColor: "#f2f2f3" }}>
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-primary text-xs uppercase tracking-widest mb-2" style={{ fontFamily: "'Inter', sans-serif" }}>
            Milestones
          </p>
          <h2 className="mb-12" style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(1.5rem, 3vw, 2rem)" }}>
                ...
                <div key={item.year} className="flex gap-6 sm:gap-10 group">
                  <div className="flex-shrink-0 w-16 text-right pt-6">
                    <span
                      ...
                      style={{ fontFamily: "'Playfair Display', serif", fontSize: "14px", fontWeight: 600 }}
                    >
                      {item.year}
                    </span>
                  </div>
                  <div className="hidden sm:flex flex-col items-center pt-6">
                    ...
                    {i < timeline.length - 1 && <div className="w-px flex-1 bg-transparent" />}
                  </div>
                  <div className="flex-1 pb-10 pt-5 border-b border-border last:border-0 sm:pl-4">
                    <h3 className="mb-2" style={{ fontFamily: "'Playfair Display', serif", fontSize: "17px" }}>
                      {item.title}
                    </h3>
